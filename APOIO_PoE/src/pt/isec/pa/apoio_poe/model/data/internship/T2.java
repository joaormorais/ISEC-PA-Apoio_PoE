...
public class T2 extends Internship implements Serializable {

    // Constructor

    // used when we add by ourselves a new internship
    public T2(String branchDestiny, String title, String professorResponsible, long studentNumber, Professor associatedProfessor, boolean associated) {
        super(branchDestiny, title, null, professorResponsible, studentNumber, associatedProfessor, associated);
    }

    // used when we add an internship using a .csv file
    public T2(String ID, String branchDestiny, String title, String professorResponsible, long studentNumber, Professor associatedProfessor, boolean associated) {
        super(ID, branchDestiny, title, null, professorResponsible, studentNumber, associatedProfessor, associated);
    }
